...
public class StreamOFInt {
	...
	public static void main(String[] args) {
		...
		//System.out.println(numList.stream().mapToInt(x->x.intValue()).reduce(0,(x,y)->{System.out.println(x+"+"+y+"="+(x+y));return x+y;}));
		
		//numList.stream().mapToInt(x->x.intValue()).reduce(0,(x,y)->x+y);
